...
function ToastItem(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
        ...
        className: "max-w-sm w-full rounded-lg shadow-lg border p-4 ".concat(getColorClasses()),
...
_s2(useToastHelpers, "ubwSGUJGTwpn9cIwx73/Ga/BuiI=", false, function() {
    return [
        useToast
    ];
});
...
"[project]/src/contexts/TenantContext.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
        ...
        "TenantProvider.useEffect": ()=>{
            async function fetchTenantInfo() {
                try {
                    ...
                    const response = await fetch("/api/tenant/".concat(tenantDomain));
                    if (!response.ok) {
...
_s(TenantProvider, "xYq5tsfqJ0k8zNT9RMTSySNVnJs=");
_c = TenantProvider;
function useTenant() {
    _s1();
...
//# sourceMappingURL=src_f0f3e8d6._.js.map
...
class CepService {
   ...
   */ async buscarCep(cep) {
        ...
        try {
            const response = await fetch("".concat(this.baseUrl, "/v1/").concat(cepLimpo));
            if (!response.ok) {
...
class CnpjService {
   ...
   */ async consultarCnpj(cnpj) {
        ...
        try {
            const response = await fetch("".concat(this.baseUrl, "/").concat(cnpjLimpo));
            if (!response.ok) {
                if (response.status === 404) {
                    throw new Error('CNPJ não encontrado na Receita Federal');
                }
                throw new Error("Erro ao consultar CNPJ: ".concat(response.statusText));
            }
   ...
   */ montarEnderecoCompleto(empresa) {
        const partes = [
            empresa.descricao_tipo_logradouro && empresa.logradouro ? "".concat(empresa.descricao_tipo_logradouro, " ").concat(empresa.logradouro) : empresa.logradouro,
            empresa.numero,
            empresa.complemento,
            empresa.bairro,
            empresa.municipio,
   ...
   */ obterTelefonePrincipal(empresa) {
        ...
        if (telefone.length === 8) {
            return "(".concat(ddd, ") ").concat(telefone.slice(0, 4), "-").concat(telefone.slice(4));
        } else if (telefone.length === 9) {
            return "(".concat(ddd, ") ").concat(telefone.slice(0, 5), "-").concat(telefone.slice(5));
        }
        return "(".concat(ddd, ") ").concat(telefone);
    }
    /**
   ...
   */ obterSociosPrincipais(empresa) {
        let limite = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 3;
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "baseUrl", 'https://brasilapi.com.br/api/cnpj/v1');
    }
}
...
class BrasilApiService {
   ...
   */ async autocompletarEndereco(cep) {
        try {
            ...
            return {
                success: false,
                erro: "Erro ao buscar endereço: ".concat(error instanceof Error ? error.message : 'Erro desconhecido')
            };
        }
    }
    /**
...
function NovoClienteModal(param) {
    ...
    const handleCepChange = async (value)=>{
        const formatted = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$brasilapi$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["brasilApi"].formatadores.cep(value);
        if (formatted.replace(/\D/g, '').length === 8) {
            setCepLoading(true);
            try {
                const resultado = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$brasilapi$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["brasilApi"].autocompletarEndereco(formatted);
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        cepLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(NovoClienteModal, "zLNq2GE6Y509ptb3YkExF1FglzQ=");
_c = NovoClienteModal;
var _c;
...
//# sourceMappingURL=src_a6f898bf._.js.map
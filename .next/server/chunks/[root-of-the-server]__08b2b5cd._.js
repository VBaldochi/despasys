...
"[project]/.next-internal/server/app/api/customers/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
async function GET() {
    try {
        ...
        const customers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeWithRetry"])(async ()=>{
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.findMany({
                where: {
...
async function POST(request) {
    try {
        ...
        const customer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].customer.create({
            data: {
                tenantId: session.user.tenantId,
                name: body.name,
                email: body.email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__08b2b5cd._.js.map
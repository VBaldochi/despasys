...
class SimpleCache {
    cache = new Map();
    defaultTTL = 1000 * 60 * 5 // 5 minutos
    ;
    set(key, data, ttl) {
...
function getCacheKey(prefix, tenantId, ...args) {
...
async function GET() {
    try {
        ...
        const cacheKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCacheKey"])('dashboard-stats', tenantId);
        // Verificar cache primeiro
        const cachedStats = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cache"].get(cacheKey);
        if (cachedStats) {
        ...
        const [customersCount, processesCount, vehiclesCount, usersCount] = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeWithRetry"])(async ()=>{
            return await Promise.all([
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].process.count({
                    where: {
                        tenantId
                    }
                }),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].veiculo.count({
                    where: {
                        tenantId
                    }
                }),
        ...
        // Cache por 2 minutos
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cache"].set(cacheKey, stats, 1000 * 60 * 2);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1527abb5._.js.map